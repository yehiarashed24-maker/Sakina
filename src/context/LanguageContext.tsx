...
export const translations = {
  ...
  ar: {
    ...
    exploreSakina: "استكشف سكينة",
    
    // About
    aboutLabel: "عن سكينة",
    aboutTitle1: "حيث تلتقي التكنولوجيا",
    aboutTitle2: "بالفهم العاطفي",
    aboutDesc: "تجمع سكينة بين الذكاء الاصطناعي والمعرفة النفسية لخلق محادثات داعمة وهادفة.",
    
    // Featured
    howWorks: "كيف تعمل سكينة",
    ragDesc: "باستخدام تقنية RAG، تسترجع سكينة معلومات نفسية موثوقة قبل توليد ردود داعمة بالذكاء الاصطناعي.",
    
    // Philosophy
    philTitle1: "التعاطف",
    philTitle2: "الذكاء",
    emoUnder: "الفهم العاطفي",
    emoDesc: "تتفهم سكينة أفكارك ومشاعرك وسياق المحادثة لخلق تفاعلات ذات معنى.",
    knowAi: "ذكاء اصطناعي مبني على المعرفة",
    knowDesc: "تسترجع سكينة المعلومات من مصادر الصحة النفسية الموثوقة قبل توليد الردود.",
    
    // Services
    whatSakinaDoes: "ماذا تقدم سكينة",
    ...
    terms: "شروط الخدمة",
    contact: "اتصل بنا",
    copyright: "© 2026 سكينة للذكاء الاصطناعي. جميع الحقوق محفوظة.",
